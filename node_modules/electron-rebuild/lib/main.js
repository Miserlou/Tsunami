  ...
  return regeneratorRuntime.async(function checkForInstalledHeaders$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        context$1$0.next = 3;
        return regeneratorRuntime.awrap(fs.stat(canary));
  ...
  return regeneratorRuntime.async(function spawnWithHeadersDir$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        context$1$0.next = 7;
        return regeneratorRuntime.awrap((0, _spawn2['default'])({ cmd: cmd, args: args, opts: opts }));
...
var getElectronModuleVersion = function getElectronModuleVersion(pathToElectronExecutable) {
  ...
  return regeneratorRuntime.async(function getElectronModuleVersion$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        args = ['-e', 'console.log(process.versions.modules)'];
        env = { ATOM_SHELL_INTERNAL_RUN_AS_NODE: '1' };
        context$1$0.next = 4;
        return regeneratorRuntime.awrap((0, _spawn2['default'])({ cmd: pathToElectronExecutable, args: args, opts: { env: env } }));
...
function installNodeHeaders(nodeVersion) {
  ...
  var arch = arguments[3] === undefined ? null : arguments[3];
  ...
  return regeneratorRuntime.async(function installNodeHeaders$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        context$1$0.prev = 2;
        context$1$0.next = 5;
        return regeneratorRuntime.awrap(checkForInstalledHeaders(nodeVersion, headersDir));
      ...
      case 10:
        ...
        context$1$0.next = 14;
        return regeneratorRuntime.awrap(spawnWithHeadersDir(cmd, args, headersDir));
...
function shouldRebuildNativeModules(pathToElectronExecutable) {
  var explicitNodeVersion = arguments[1] === undefined ? null : arguments[1];
  var args, version;
  return regeneratorRuntime.async(function shouldRebuildNativeModules$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        context$1$0.prev = 0;
        args = ['-e', 'require("nslog")'];
        context$1$0.next = 4;
        return regeneratorRuntime.awrap((0, _spawn2['default'])({ cmd: process.execPath, args: args }));
      ...
      case 10:
        ...
        context$1$0.next = 14;
        return regeneratorRuntime.awrap(getElectronModuleVersion(pathToElectronExecutable));
...
function rebuildNativeModules(nodeVersion, nodeModulesPath) {
  ...
  return regeneratorRuntime.async(function rebuildNativeModules$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 3:
        cmd = 'node';
        args = [require.resolve('npm/bin/npm-cli'), 'rebuild', '--target=' + nodeVersion, '--arch=' + (arch || process.arch)];
        context$1$0.next = 7;
        return regeneratorRuntime.awrap(spawnWithHeadersDir(cmd, args, headersDir, nodeModulesPath));
