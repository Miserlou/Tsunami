...
shouldRebuildPromise.then(function (x) {
  ...
  return (0, _mainJs.installNodeHeaders)(argv.v, null, null, argv.a).then(function () {
    return (0, _mainJs.rebuildNativeModules)(argv.v, argv.m, null, argv.a);
  }).then(function () {
