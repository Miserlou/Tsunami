...
Swarm.prototype._drain = function() {
	...
	var cb = function(connection) {
	 ...
	 //    console.log("Getting btpeer for addr");
	 //    console.log(connection.bt_target);

		// var baddr = connection.bt_target;
	 //    var peer = self._peers[addr];

	    // console.log("peer");
	    // console.log(peer);

	    // if (!peer) console.log("returning no peer.."); return;
