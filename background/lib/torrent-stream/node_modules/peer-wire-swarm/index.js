...
var onwire = function(swarm, connection, onhandshake, isServer) {
	...
	var destroy = function() {
		console.log("OW DESTROY..");
		console.log("read");
		console.log(connection.bytesRead);
		console.log("written");
		console.log(connection.bytesWritten);
	...
	console.log("onwireing..");
	//console.log(connection);

	connection.on('connect', function() {
		console.log("OW CONNECT..");
...
var join = function(port, swarm) {
	...
	if (!pool) {
		...
		var onconnection = function(connection) {
			console.log("join onnconnection");
...
Swarm.prototype._drain = function() {
	...
	var proxyconnected = function(socket){
		...
		console.log("Starting to onwire..");
		console.log("connection");
	...
	// Skip IPv6 for right now.
	if (addr.indexOf('[') > -1){ console.log("Skipping IPv6 address."); return; }
	//else{ console.log("Not skipping IPv4 address.")}

	var parts = addr.split(':');
	var connection;

	if(this.utp && !peer.noUtp) {
		console.log("UTP BABY :(");
		...
		if(CONNECTED){ console.log("Already connected. Bye."); return; }
		...
		console.log("addr");
		console.log(addr);
		//var socket = proxysocket.create('127.0.0.1', 9050); // Tor will always be 9050? Maybe?
		//socket.connect(parts[0], parts[1]);
		...
		// while(CURRENT_SOCKET == undefined){}
