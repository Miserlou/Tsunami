...
var DROP_ME = [0x00,0x00,0x00,0x05];
...
var Wire = function(opts) {
	...
	var onmessagelength = function(buffer) {
		...
		console.log("on message length buffffer is..");
		console.log(buffer);
		console.log(buffer.toString());

		if (length){
			var psdd = self._parse(length, onmessage);
			//console.log("parsed:");
			//console.log(psdd);
			//onmessage(buffer);
			return psdd;
	...
	var onmessage = function(buffer) {
		...
		// if(buffer.toString('utf8') == "<Buffer 00 00 00 05>"){
		// 	console.log("BAD PACKET");
		// 	return;
		// }

		// if(buffer.toString('utf8') == "<Buffer 00 00 00 01 02>"){
		// 	console.log("BAD PACKET");
		// 	return;
		// }
		...
		//Parsing length:
		//963473250
		//on message length buffffer is..
		//<Buffer 39 6d 6f 62>
		//9mob


		// var bufzero = buffer[0];
		// console.log("bufzero is");
		// console.log(bufzero);
...
Wire.prototype.handshake = function(infoHash, peerId, extensions) {
	...
	console.log("pushing handshake dataaaaaa");
	// console.log(MESSAGE_PROTOCOL);
	// console.log(reserved);
	// console.log(infoHash);
	// console.log(peerId);
	this._push(Buffer.concat([MESSAGE_PROTOCOL, reserved, infoHash, peerId], MESSAGE_PROTOCOL.length+48));
	console.log("Lets hope that worked.");
};
...
Wire.prototype.interested = function() {
	...
	this._push(MESSAGE_INTERESTED);
	 console.log(MESSAGE_INTERESTED);
	console.log("TOLD THEM IM INTERESTED");
};
...
Wire.prototype._parse = function(size, parser) {
	...
	this._parser = parser;
	console.log("I am parsing something!");
};
...
Wire.prototype._write = function(data, encoding, callback) {
	...
	console.log('Wrote, calling back..');
